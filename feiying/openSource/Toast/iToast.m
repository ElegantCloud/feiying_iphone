...
- (void) show{
	...
	if (theSettings.gravity == iToastGravityTop) {
		point = CGPointMake(window.frame.size.width / 2, 50);
	...
	}else if (theSettings.gravity == iToastGravityTopCenter) {
		point = CGPointMake(window.frame.size.width/2, window.frame.size.height/3);
	}else{
